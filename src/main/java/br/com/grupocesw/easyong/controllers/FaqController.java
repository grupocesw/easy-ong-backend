...
public class FaqController {
	...
	@ApiOperation(value = "Create new FAQ - Endpoint restricted to admin users")
	@ApiResponses(value = {
	...
	@ApiOperation(value = "Update specific FAQ - Endpoint restricted to admin users")
	@ApiResponses(value = {
	...
	@ApiOperation(value = "Delete specific FAQ - Endpoint restricted to admin users")
	@ApiResponses(value = {
