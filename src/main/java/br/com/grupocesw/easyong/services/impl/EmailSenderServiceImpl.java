...
public class EmailSenderServiceImpl implements EmailSenderService {
	...
	public void sendUserRegister(User user, String link) throws IOException {
		try {
			...
			helper.setText(buildEmail(user, link), true);
    ...
    private String buildEmail(User user, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "                      <span style=\"font-family:Helvetica,Arial,sans-serif;font-weight:700;color:#ffffff;text-decoration:none;vertical-align:top;display:inline-block\">Easy ONG - Confirmação de Email</span>\n" +
                "                    </td>\n" +
                "                  </tr>\n" +
                "                </tbody></table>\n" +
                "              </a>\n" +
