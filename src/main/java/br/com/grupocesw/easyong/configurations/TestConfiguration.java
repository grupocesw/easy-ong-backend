...
public class TestConfiguration implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		sr.saveAll(Arrays.asList(s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, s20, s21, s22, s23, s24, s25, s26, s27));
		...
		Ngo n1 = new Ngo(null, "Ong Cantinho Feliz", "59300268000191", a1,"Lorem ipsum hendrerit ut arcu dapibus etiam habitant faucibus gravida egestas, ut porttitor blandit venenatis per vestibulum venenatis massa leo quisque, pretium mattis auctor lorem curabitur ut aliquet praesent libero.");
		Ngo n2 = new Ngo(null, "Ong Bom de Boa", "26809488000196", a2,"Lorem ipsum hendrerit ut arcu dapibus etiam habitant faucibus gravida egestas, ut porttitor blandit venenatis per vestibulum venenatis massa leo quisque, pretium mattis auctor lorem curabitur ut aliquet praesent libero.");
		Ngo n3 = new Ngo(null, "Ong Green Side", "52851775000174", a3,"Lorem ipsum hendrerit ut arcu dapibus etiam habitant faucibus gravida egestas, ut porttitor blandit venenatis per vestibulum venenatis massa leo quisque, pretium mattis auctor lorem curabitur ut aliquet praesent libero.");	
