...
public class TestConfiguration implements CommandLineRunner {
	...
	faqs.addAll(Arrays.asList(
		new FrequentlyAskedQuestion(null, "Pergunta 1", "Resposta 1"),
		new FrequentlyAskedQuestion(null, "Pergunta 2", "Resposta 2"),
		new FrequentlyAskedQuestion(null, "Pergunta 3", "Resposta 3"),
		new FrequentlyAskedQuestion(null, "Pergunta 4", "Resposta 4"),
		new FrequentlyAskedQuestion(null, "Pergunta 5", "Resposta 5"),
		new FrequentlyAskedQuestion(null, "Pergunta 6", "Resposta 6"),
		new FrequentlyAskedQuestion(null, "Pergunta 7", "Resposta 7"),
		new FrequentlyAskedQuestion(null, "Pergunta 8", "Resposta 8"),
		new FrequentlyAskedQuestion(null, "Pergunta 9", "Resposta 9"),
		new FrequentlyAskedQuestion(null, "Pergunta 10", "Resposta 10")
	...
	states.addAll(Arrays.asList(new State(null, "Acre", "AC", countries.get(0)),
			...
			new State(null, "Ceará", "CE", countries.get(0)), new State(null, "Espírito Santo", "ES", countries.get(0)),
			...
			new State(null, "Minas Gerais", "MG", countries.get(0)), new State(null, "Pará", "PA", countries.get(0)),
			new State(null, "Paraíba", "PB", countries.get(0)), new State(null, "Paraná", "PR", countries.get(0)),
			...
			new State(null, "São Paulo", "SP", countries.get(0)), new State(null, "Sergipe", "SE", countries.get(0)),
	...
	zipCodes.addAll(
			Arrays.asList(new ZipCode(null, "01227000"), new ZipCode(null, "01304001"), new ZipCode(null, "01156050")));
	...
	informations.addAll(Arrays.asList(new MoreInformationNog(null, "No ano de 2020 foram doadas 800 cestas básicas."),
	...
	userPictures.addAll(Arrays.asList(new Picture(null, "4_user.jpg")));
	...
	users.addAll(Arrays.asList(
			...
			new User(null, "Biri Jean", LocalDate.parse("1983-07-23"), Gender.MALE, "birijean@easyong.com.br",
					"123456"),
			new User(null, "Paul Stronger", LocalDate.parse("1998-05-04"), Gender.MALE, "paulstronger@easyong.com.br",
					"123456"),
			...
			new User(null, "Mirna Kyle", LocalDate.parse("1967-03-09"), Gender.FEMALE, "mirnakyle@easyong.com.br",
					"123456"),
			new User(null, "Tricia Marcos", LocalDate.parse("1984-12-25"), Gender.OTHER, "triciamarcos@easyong.com.br",
					"123456")));
