...
public class TestConfiguration implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {		
		...
		socialCauses.addAll(Arrays.asList(
			new SocialCause(null, "Educação"),
			new SocialCause(null, "Proteção Animal"),
			new SocialCause(null, "Direitos Humanos"),
			new SocialCause(null, "Esporte e Cultura"),
			new SocialCause(null, "Meio Ambiente"),
			new SocialCause(null, "Luta Contra Fome"),
			new SocialCause(null, "Saúde e Bem Estar"),
			new SocialCause(null, "Direitos Humanos")
		));
		...
		countries.addAll(Arrays.asList(
				new Country(null, "Brasil", "BRA")
		));
		cr.saveAll(countries);

		List<State> states = new ArrayList<>();
		states.addAll(Arrays.asList(
			new State(null, "Acre", "AC", countries.get(0)),
			new State(null, "Alagoas", "AL", countries.get(0)),
			new State(null, "Amapá", "AP", countries.get(0)),
			new State(null, "Amazonas", "AM", countries.get(0)),
			new State(null, "Bahia", "BA", countries.get(0)),
			new State(null, "Ceará", "CE", countries.get(0)),
			new State(null, "Espírito Santo", "ES", countries.get(0)),
			new State(null, "Goiás", "GO", countries.get(0)),
			new State(null, "Maranhão", "MA", countries.get(0)),
			...
			new State(null, "Pará", "PA", countries.get(0)),
			new State(null, "Paraíba", "PB", countries.get(0)),
			new State(null, "Paraná", "PR", countries.get(0)),
			new State(null, "Pernambuco", "PE", countries.get(0)),
			new State(null, "Piauí", "PI", countries.get(0)),
			...
			new State(null, "Rondônia", "RO", countries.get(0)),
			new State(null, "Roraima", "RR", countries.get(0)),
		...
		cities.addAll(Arrays.asList(
			new City(null, "Belo Horizonte", states.get(11)),
			new City(null, "São Paulo", states.get(24)),
			new City(null, "Rio de Janeiro", states.get(17))
		));
		ctr.saveAll(cities);
		
		List<ZipCode> zipCodes = new ArrayList<>();
		zipCodes.addAll(Arrays.asList(
			new ZipCode(null, "01227000"),
			new ZipCode(null, "01304001"),
		...
		districts.addAll(Arrays.asList(
			new District(null, "Santa Cecília", cities.get(1)),
			new District(null, "Consolação", cities.get(1)),
			new District(null, "Barra Funda", cities.get(1))
		));
		dr.saveAll(districts);
		
		List<Street> streets = new ArrayList<>();
		streets.addAll(Arrays.asList(
			new Street(null, "Avenida Angélica", zipCodes.get(0), districts.get(0)),
		...
		addresses.addAll(Arrays.asList(
		    new Address(null, 19, streets.get(0)),
			new Address(null, 365, streets.get(1)),
			new Address(null, 876, streets.get(2))
		));
		
		List<Picture> ngoPictures = new ArrayList<>();
		ngoPictures.addAll(Arrays.asList(
		    new Picture(null, "1_ong.jpeg"),
		    new Picture(null, "2_ong.png"),
		...
		ngos.addAll(Arrays.asList(
			new Ngo(null, "Ong Cantinho Feliz", "59300268000191", addresses.get(0),
			 ...
			 new Ngo(null, "Ong Bom de Boa", "26809488000196", addresses.get(1),
				"Lorem ipsum hendrerit ut arcu dapibus etiam habitant faucibus gravida egestas, ut porttitor blandit venenatis per vestibulum venenatis massa leo quisque, pretium mattis auctor lorem curabitur ut aliquet praesent libero."),
		...
		contacts.addAll(Arrays.asList(
			new Contact(null, ContactType.WHATSAPP, "011954563652"),
		...
		informations.addAll(Arrays.asList(
			new MoreInformationNog(null, "No ano de 2020 foram doadas 800 cestas básicas."),
		...
		userPictures.addAll(Arrays.asList(
		    new Picture(null, "1_ong.jpeg")
		));
		picr.saveAll(userPictures);

		List<User> users = new ArrayList<>();
		users.addAll(Arrays.asList(
				new User(null, "Astrobilobaldo Paixão", LocalDate.parse("1990-09-22"), Gender.MALE, "astrobilobaldo@test.com", "123456"),
				new User(null, "Biri Jean", LocalDate.parse("1983-07-23"), Gender.MALE, "birijean@easyong.com.br", "123456"),
				new User(null, "Paul Stronger", LocalDate.parse("1998-05-04"), Gender.MALE, "paulstronger@easyong.com.br", "123456"),
				new User(null, "Sander Jay", LocalDate.parse("1996-11-29"), Gender.MALE, "sanderjay@easyong.com.br", "123456"),
				new User(null, "Juma Haskov", LocalDate.parse("2000-06-07"), Gender.FEMALE, "jumahaskov@easyong.com.br", "123456"),
				new User(null, "Mirna Kyle", LocalDate.parse("1967-03-09"), Gender.FEMALE, "mirnakyle@easyong.com.br", "123456"),
				new User(null, "Tricia Marcos", LocalDate.parse("1984-12-25"), Gender.OTHER, "triciamarcos@easyong.com.br", "123456")
		));
		...
		users.get(0).getPictures().addAll(userPictures);
		ur.saveAll(users);
	}
