INSERT INTO frequently_asked_question (id, answer, question) VALUES
...
INSERT INTO social_cause (id, name) VALUES
(1, 'Educação'),
(2, 'Proteção Animal'),
(3, 'Direitos Humanos'),
(4, 'sporte e Cultura'),
...
INSERT INTO state (id, name, abbreviation, country_id) VALUES
(1, 'Alagoas', 'AL', 1),
(2, 'Amapá', 'AP', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Bahia', 'BA', 1),
...
INSERT INTO zip_code (id, number) VALUES
(1, '01227000'),
(2, '01304001'),
(3, '01156050');

INSERT INTO street (id, name, district_id, zip_code_id) VALUES
